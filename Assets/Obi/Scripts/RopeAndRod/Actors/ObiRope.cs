...
namespace Obi
{
    ...
    public class ObiRope : ObiRopeBase, IDistanceConstraintsUser, IBendConstraintsUser
    {
        ...
        public void ApplyTearingRightNow()
        {
            float _substepTime = Time.fixedDeltaTime / GetComponentInParent<ObiFixedUpdater>().substeps;


            float sqrTime = _substepTime * _substepTime;
